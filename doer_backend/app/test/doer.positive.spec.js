...
async function getData(url) {
	try {
		const response = await request.get(url).set("Accept", "application/json").set("Authorization", DOER_AUTH_TOKEN);
		return response;
	} catch (error) {
		throw error;
	}
...
describe("DOER API Tests -- POSITIVE TESTS", () => {
	test("Create a new doer", async () => {
		const res = await request.post(test_uris.createDoerUri).send(global_modules["doer.test.data"].reqCreateDoer_1).set("Accept", "application/json").set("Authorization", DOER_AUTH_TOKEN);
	...
	test("Create a new doer", async () => {
		const res = await request.post(test_uris.createDoerUri).send(global_modules["doer.test.data"].reqCreateDoer_2).set("Accept", "application/json").set("Authorization", DOER_AUTH_TOKEN);
		//   console.log(res.body);
		expect(res.status).toBe(200);
		expect(JSON.stringify(res.body)).toContain("doer_id");
	...
	test("Create a new doer", async () => {
		const res = await request.post(test_uris.createDoerUri).send(global_modules["doer.test.data"].reqCreateDoer_3).set("Accept", "application/json").set("Authorization", DOER_AUTH_TOKEN);
		//   console.log(res.body);
		expect(res.status).toBe(200);
		expect(JSON.stringify(res.body)).toContain("doer_id");
	});
	...
	test("Create a new user", async () => {
		const res = await request.post(test_uris.createUserUri).send(global_modules["user.test.data"].reqCreateUser_1).set("Accept", "application/json").set("Authorization", DOER_AUTH_TOKEN);
		expect(res.status).toBe(200);
	...
	test("Create a new Job Request", async () => {
		...
		const res = await request.post(test_uris.createJobUri).send(job_req).set("Accept", "application/json").set("Authorization", DOER_AUTH_TOKEN);
		expect(res.status).toBe(200);
	...
	test("Search Doers by Day and Service", async () => {
		const res = await request.get(test_uris.getDoerByServicesAndDayRequestUri + "?day=Sat&services=electric").set("Accept", "application/json").set("Authorization", DOER_AUTH_TOKEN);
		//    console.log(res.body);
		expect(res.status).toBe(200);
		expect(JSON.stringify(res.body)).toContain("doer_id");
	});
	...
	test("Get Doer by ID", async () => {
		const res = await request.get(test_uris.getDoerByIdRequestUri + "?id=" + global_doerId).set("Accept", "application/json").set("Authorization", DOER_AUTH_TOKEN);
		//  console.log(res.body);
		expect(res.status).toBe(200);
		expect(JSON.stringify(res.body)).toContain("doer_id");
	});
	...
	test("Get Doer for Job", async () => {
		const res = await request.get(test_uris.getDoerForJobRequestUri + "?jobId=" + global_jobId).set("Accept", "application/json").set("Authorization", DOER_AUTH_TOKEN);
		//  console.log(res.body);
		expect(res.status).toBe(200);
		expect(JSON.stringify(res.body)).toContain("doer_id");
	});
	...
	test("Get Doer History", async () => {
		const res = await request.get(test_uris.getDoerHistoryRequestUri + "?id=" + global_doerId).set("Accept", "application/json").set("Authorization", DOER_AUTH_TOKEN);
		//  console.log(res.body);
		expect(res.status).toBe(200);
		expect(JSON.stringify(res.body)).toContain("doer_id");
	});
	...
	test("Rate Doer", async () => {
		const res = await request.post(test_uris.rateDoerRequestUri + "?id=" + global_doerId + "&rating=5").send().set("Accept", "application/json").set("Authorization", DOER_AUTH_TOKEN);
		//  console.log(res.body);
		expect(res.status).toBe(200);
		expect(JSON.stringify(res.body)).toContain("doer_id");
	});
	...
	test("Create a new BADGE", async () => {
		const res = await request.post(test_uris.createBadgeUri).send(global_modules["badge.test.data"].reqCreateBadge_2).set("Accept", "application/json").set("Authorization", DOER_AUTH_TOKEN);
		expect(res.status).toBe(200);
